...
<head>
  ...
  <div style="text-align: center;">
    ...
    <!-- Hero image -->
    <img style="width: 600px; max-width: 600px; height: 350px; max-height: 350px; text-align: center;" alt="Logo Image" src="https://github.com/agricio/TinDev/blob/master/assets_git/logomail.jpg?raw=true" align="center" width="600" height="350">
    <!-- Hero image -->
    ...
    <table align="center" style="text-align: center; vertical-align: top; width: 600px; max-width: 600px; background-color: #ffffff;" width="600">
        <tbody>
          <tr>
            <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
              ...
              <h1 style="font-size: 25px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">Thank you {{firstName}} {{lastName}}!</h1>

              <p style="font-size: 18px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293;">We are happy that you have chosen us!. We will get back to you {{email}} or tel: {{phone}} as soon as possible, thank you!.</p>              
              ...
              <a href="https://porfolio-khaki.vercel.app/" target="_blank" style="background-color: #2178cf; font-size: 20px; line-height: 22px; font-family: 'Helvetica', Arial, sans-serif; font-weight: normal; text-decoration: none; padding: 12px 15px; color: #ffffff; border-radius: 5px; display: inline-block; mso-padding-alt: 0;">
                ...
                <![endif]-->
                  ...
                  <span style="mso-text-raise: 15pt; color: #ffffff;">Go to Website</span>
                  <!--[if mso]>
      ...
      <!-- Start footer -->
      <table align="center" style="text-align: center; vertical-align: top; width: 600px; max-width: 600px; background-color: #2178cf;" width="600">
        <tbody>
          <tr>
